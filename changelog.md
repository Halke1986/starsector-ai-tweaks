...
- Ships are less likely to select unusual attack angles, especially when equipped with front shields. This fixes the issue of Gryphons flying backwards. It's still possible to force ships equipped with omni shields to fly backwards. Reported by 颯爽的夏亞.
