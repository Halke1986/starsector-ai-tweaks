package com.genir.aitweaks.core.features.shipai.loading

class Compiler(private val scriptLoader: ClassLoader, private val obf: Deobfuscator.Symbols) {
    fun compileClasses(): Map<String, ByteArray> {
        return compileVanillaClasses() + compileAdapterClasses()
    }

    private fun compileVanillaClasses(): Map<String, ByteArray> {
        ...
        return vanillaSources.mapValues { compile(it.value, vanillaTransformer) }
    }

    private fun compileAdapterClasses(): Map<String, ByteArray> {
        val adapterSources: Map<String, String> = mapOf(
            "com.genir.aitweaks.asm.shipai.Strafe" to "com.genir.aitweaks.core.features.shipai.adapters.Strafe",
            "com.genir.aitweaks.asm.shipai.Approach" to "com.genir.aitweaks.core.features.shipai.adapters.Approach",
            "com.genir.aitweaks.asm.shipai.Move" to "com.genir.aitweaks.core.features.shipai.adapters.Move",
            "com.genir.aitweaks.asm.shipai.ManeuverAdapter" to "com.genir.aitweaks.core.features.shipai.adapters.ManeuverAdapter",
            "com.genir.aitweaks.asm.shipai.EngineAIAdapter" to "com.genir.aitweaks.core.features.shipai.adapters.EngineAIAdapter",
        )

        val adapterTransformer = Transformer(listOf(
            // Rename aitweaks classes.
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/Strafe", "com/genir/aitweaks/asm/shipai/Strafe"),
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/Approach", "com/genir/aitweaks/asm/shipai/Approach"),
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/Move", "com/genir/aitweaks/asm/shipai/Move"),
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/ManeuverAdapter", "com/genir/aitweaks/asm/shipai/ManeuverAdapter"),
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/EngineAIAdapter", "com/genir/aitweaks/asm/shipai/EngineAIAdapter"),

            // Replace stub types.
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/ManeuverInterface", "com/fs/starfarer/combat/ai/movement/maneuvers/${obf.maneuverInterface}"),
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/FlockingAI", "com/fs/starfarer/combat/ai/movement/${obf.flockingAIModule}"),
            Transformer.newTransform("com/genir/aitweaks/core/features/shipai/adapters/ShipAI", "com/fs/starfarer/combat/ai/movement/maneuvers/${obf.shipAIInterface}"),
        ...
        return adapterSources.mapValues { compile(it.value, adapterTransformer) }
    }

    private fun compile(sourceName: String, transformer: Transformer): ByteArray {
